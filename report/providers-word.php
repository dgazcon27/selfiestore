...
$table1->addRow();
$table1->addCell()->addText("RFC/RUT",'estilocelda', 'p2Style');
...
$table1->addCell(5000)->addText($client->name." ".$client->lastname,'estilocelda', 'p2Style');
$table1->addCell(2500)->addText($client->address1,'estilocelda', 'p2Style');
