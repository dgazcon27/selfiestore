...
echo number_format($totin,2,".",",");
    ...
    <td><?php echo number_format($totout,2,".",","); ?></td>
    <td><?php echo number_format($totout2,2,".",","); ?></td>
    <td><?php echo number_format($totout2-$totout,2,".",","); ?></td>
    <td><?php echo number_format($totin-$totout,2,".",","); ?></td>
		<td style="width:93px;">
<!--		<a href="index.php?view=input&product_id=<?php echo $product->id; ?>" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-circle-arrow-up"></i> Alta</a>-->
  ...
  <tr>
    ...
    <td>(Total)</td>
    <td></td>
    <td>$ <?php echo number_format($ttin,2,".",","); ?></td>
    <td>$ <?php echo number_format($ttout,2,".",","); ?></td>
    <td>$ <?php echo number_format($ttou2,2,".",","); ?></td>
    <td>$ <?php echo number_format($ttou2-$ttout,2,".",","); ?></td>
    <td>$ <?php echo number_format($ttin-$ttout,2,".",","); ?></td>
    <td></td>
  </tr>
</table>
  </div><!-- /.box-body -->
...
var doc = new jsPDF('p', 'pt');
        ...
        doc.setFontSize(18);
        doc.text("VALOR DEL INVENTARIO: <?php echo $stock->name;?>", 150, 80);
        doc.setFontSize(12);
        doc.text("Usuario: <?php echo Core::$user->name." ".Core::$user->lastname; ?>  -  Fecha: <?php echo date("d-m-Y h:i:s");?> ", 135, 90);
  ...
  ?>
    {
      ...
      "total_re": "$ <?php echo number_format($totin,2,".",","); ?>",
      "total_sell": "$ <?php echo number_format($totout,2,".",","); ?>",
      "total_now": "$ <?php echo number_format($totin-$totout,2,".",","); ?>",
      },
 <?php endforeach; ?>
    {
      "code": "",
      "product": "Total",
      "disponible": "",
      "total_re": "$ <?php echo number_format($ttin,2,".",","); ?>",
      "total_sell": "$ <?php echo number_format($ttout,2,".",","); ?>",
      "total_now": "$ <?php echo number_format($ttin-$ttout,2,".",","); ?>",
      },
];
