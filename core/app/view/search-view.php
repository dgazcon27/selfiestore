...
<!-- Single button -->
		...
		<h1><i class='fa fa-search'></i> BUSCAR PRODUCTOS</h1>
<form class="form-inline">
<input type="hidden" name="view" value="search">
  <div class="form-group">
    <label class="sr-only" for="exampleInputEmail3">BUSCAR</label>
    <input type="text" name="q" required class="form-control" id="exampleInputEmail3" placeholder="NOMBRE DEL PRODUCTO O CODIGO DE BARRA">
  </div>
