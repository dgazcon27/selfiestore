...
<div class="row">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="no" value="<?php echo $user->no;?>" class="form-control" id="no" placeholder="Número de identificación">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="name" value="<?php echo $user->name." ".$user->lastname;?>" class="form-control" id="name" placeholder="Nombre Completo*">
    </div>
  </div>
  <div class="form-group">
