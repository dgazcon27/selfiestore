...
else
{
	...
	$ceo = ($superganancia-$superdescuento)*0.70;
	$ing = ($superganancia-$superdescuento)*0.10;	
	$vit = ($superganancia-$superdescuento)*0.10;	
...
<h4>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp; CEO [70%] : $ <?php echo number_format($ceo,2,'.',','); ?> &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp; GERENTE [10%] : $ <?php echo number_format($ing,2,'.',','); ?> &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp; SOCIEDAD [10%] : $ <?php echo number_format($vit,2,'.',','); ?> &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp; PERSONAL [10%] : $ <?php echo number_format($mar,2,'.',','); ?>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;</h4>
