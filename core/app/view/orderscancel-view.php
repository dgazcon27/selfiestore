<section class="content"> 
	<div class="row">
		<div class="col-md-12">
			...
			<h1><i class='glyphicon glyphicon-shopping-cart'></i> Pedidos Canceladas</h1>
			<?php 
			else:
			?>
			...
			<h1><i class='glyphicon glyphicon-shopping-cart'></i> Pedidos Cancelados</h1>
			<?php
			endif;
			?>
			...
			<?php
				$products = null;
				$products = SellData::getOrdersCancels();
			if(count($products)>0){
			?>
			<br>
					...
					<table class="table table-bordered table-hover table-responsive datatable">
						...
						<tr>
							...
							<td style="width:130px;text-align: center;">
								...
								<a href="index.php?view=delcotization&from=orders&id=<?php echo $sell->id; ?>" class="btn btn-xs btn-danger" onclick="return confirm('CONFIRMAS QUE QUIERES ELIMINAR ESTE PEDIDO');">
			...
			?>
			<div class="jumbotron">
				<p>No se ha cancelado ningun pedido.</p>
			</div>
			<?php
			}
			?>
