...
//////////////////////////////////
		if($process==true){
			...
			$sell->iva=  $iva_val;
			$sell->cash = str_replace(",", ".", $_POST["money"]);
			$sell->total = str_replace(",", ".", $_POST["total"]);
...
print "<br><p class='alert alert-success'>VENTA PROCESADA EXITOSAMENTE &nbsp;&nbsp;&nbsp;&nbsp;<a target='_blank' href='ticket.php?id=$s[1]' class='btn-xs btn btn-info'><i class='fa fa-ticket'></i> VER TÍCKET</a> <a href='index.php?view=onesell&id=$s[1]' class='btn-xs btn btn-primary'>VER RESUMEN</a> </p>";
		}
	}
}
